...
const displayPostsStatistics = async () => {
  ...
  try {
    const data = await fetch(`${serverUrl}api/data`);
...
const printPosts = async (type) => {
  try {
    ...
    const data = await fetch(`${serverUrl}api/data?type=${type}`);
    const posts = await data.json();
...
const getPostsByUsername = async () => {
  ...
  try {
    ...
    const data = await fetch(`${serverUrl}api/data?username=${username}`);
    const posts = await data.json();
...
const deletePost = async (postId) => {
  try {
    ...
    const response = await fetch(`${serverUrl}api/data/${postId}`, {
      method: 'DELETE',
      headers: {
